...
[![conformance](https://img.shields.io/badge/conformance-919%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
| **Graph** | edge tables, `RELATE`, properties on the edge, multi-hop traversal in both directions, an edge table that names the pair it joins and refuses every other | 24 | ✅ runs |
