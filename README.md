...
[![conformance](https://img.shields.io/badge/conformance-928%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
| **Graph** | edge tables, `RELATE`, properties on the edge, multi-hop traversal in both directions, an edge table that names the pair it joins and refuses every other, a declared graph the node tables belong to | 33 | ✅ runs |
