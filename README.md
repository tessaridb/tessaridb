...
[![conformance](https://img.shields.io/badge/conformance-524%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
|---|---|---|:--|
| **Documents** | schemaless or schemafull records, nested objects and arrays, typed fields with defaults | 38 + 72 | ✅ runs |
