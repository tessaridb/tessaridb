...
[![conformance](https://img.shields.io/badge/conformance-974%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
| **Vector** | cosine, Euclidean and dot distance, kNN ordering, a graph index that declares whether it answered exactly, and a field that declares how wide its vectors are so a write of any other width is refused where it happens | 26 | ✅ runs |
