...
[![conformance](https://img.shields.io/badge/conformance-1052%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
| **Full-text** | per-field analyzers, whole-term search, prefix search a reader is served by while still typing, fuzzy search that survives a typo, lowercase · ASCII folding · Porter2 stemming | 51 | ✅ runs |
