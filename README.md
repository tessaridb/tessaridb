...
[![conformance](https://img.shields.io/badge/conformance-884%20cases-6B5FD1?style=flat-square)](crates/tessari-conformance/tests/corpus)
...
|---|---|---|:--|
| **Documents** | schemaless or schemafull records, nested objects and arrays, typed fields with defaults | 38 + 78 | ✅ runs |
| **Relational** | declared tables and fields, unique and multi-field indexes, joins whose answer an index may not change, `INSERT` of several records in one statement at identities the store produces | 62 + 27 + 51 + 14 | ✅ runs |
