...
//!
//! Not a running estimate, and not a bucketed histogram. A cumulative histogram
//! reports a healthy p99 straight through a real regression, because the bad
//! tail is diluted by every operation that came before it — which is precisely
//! the failure a benchmark exists to catch. A retained sample costs sixteen
