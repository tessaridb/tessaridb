//! The executable definition of bgvQL.
//!
//! `docs/bgvql.md` says what the language is; this crate is where that claim is
...
//!   `docs/bgvql.md` itself. This catches the document and the parser drifting
