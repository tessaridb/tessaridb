...
//! ```
//!
//! Expectations are written in TessariQL where they name a value, because a suite
...
pub enum Expectation {
    ...
    Keys(usize),
    /// The last statement answered with this value, written as TessariQL.
    Value(String),
}
