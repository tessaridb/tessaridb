...
#[cfg(feature = "server")]
use tessari_storage::{Change, ChangeKind};
#[cfg(feature = "server")]
...
impl Happened {
    ...
    #[cfg(feature = "server")]
    #[must_use]
    pub fn hiding(self, visible: &tessari_session::redact::Visible) -> Self {
        match self.became {
            Became::Written(held) => Self {
                became: Became::Written(tessari_session::redact::seen(held, visible)),
                ..self
            },
